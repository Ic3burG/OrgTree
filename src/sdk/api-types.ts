...
export interface paths {
  ...
  '/organizations/{orgId}/ownership/transfer': {
     ...
     * @description Start the process of transferring organization ownership. Requires owner role.
     */
    post: {
      parameters: {
        query?: never;
  ...
  '/organizations/{orgId}/ownership/transfers': {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    /**
     * List organization transfers
     * @description List all transfers for an organization. Requires admin role or above.
     */
    get: {
      parameters: {
        query?: {
  ...
  '/ownership/transfers/pending': {
     ...
     * @description Get pending transfers where the current user is the recipient.
     */
    get: {
      parameters: {
        query?: never;
  ...
  '/ownership/transfers/{transferId}/accept': {
    ...
    /**
     * Accept transfer
     * @description Accept an ownership transfer. Current user must be the recipient.
     */
    post: {
      parameters: {
        query?: never;
  ...
  '/ownership/transfers/{transferId}/reject': {
    ...
    /**
     * Reject transfer
     * @description Reject an ownership transfer.
     */
    post: {
      parameters: {
        query?: never;
  ...
  '/ownership/transfers/{transferId}/cancel': {
    ...
    /**
     * Cancel transfer
     * @description Cancel a pending transfer. Requester must be the initiator (owner).
     */
    post: {
      parameters: {
        query?: never;
  ...
  '/ownership/transfers/{transferId}/audit-log': {
     ...
     * @description Get history of actions for this transfer.
     */
    get: {
      parameters: {
        query?: never;
