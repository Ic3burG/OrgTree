...
function PublicOrgMapContent(): React.JSX.Element {
  ...
  return (
    <div className="w-full h-dvh relative bg-slate-50 dark:bg-slate-900">
      ...
      {/* Public View Badge */}
      <div className="absolute top-4 left-4 z-10 bg-white dark:bg-slate-800 rounded-lg shadow-lg px-3 py-2 lg:px-4 lg:py-3 border border-slate-200 dark:border-slate-700">
        <div className="flex items-center gap-2 lg:gap-3">
          <svg
            className="hidden lg:block w-6 h-6 text-blue-600 dark:text-blue-400"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <div>
            <h1 className="text-sm lg:text-base font-semibold text-slate-900 dark:text-slate-100">
              {orgName}
            </h1>
            <p className="hidden lg:block text-xs text-slate-500 dark:text-slate-400">
              Public view &bull; Read only
            </p>
          </div>
        </div>
      </div>
