...
14. **Invitation Enhancements** - Resend expired invitations, custom expiry periods, reminder emails (see [docs/rfc/invitation-enhancements.md](rfc/invitation-enhancements.md))
